...
e
    ...
    | e '-' e
        {$$ = { nodeType: 'BinaryOperation', operation: '-', left: $1, right: $3, location: @$ };}
    | e '*' e
        // Error: only three symbols but references `@4`
        {$$ = { nodeType: 'BinaryOperation', operation: '*', left: $1, right: $3, location: { first_line: @1.first_line, first_column: @1.first_column, last_line: @3.last_line, last_column: @4.last_column } };}
    | e '/' e
        {$$ = { nodeType: 'BinaryOperation', operation: '/', left: $1, right: $3, location: @$ };}
    | e '^' e
        {$$ = { nodeType: 'BinaryOperation', operation: '^', left: $1, right: $3, location: @$ };}
